...
You have to design & build the backend for the application and the ability for the users to register, read news, follow different news topics etc.
...
https://github.com/azaylamba/inshorts 
